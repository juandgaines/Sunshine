...
import com.example.juandavid.sunshine.data.WeatherContract.WeatherEntry;
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                ContentValues[] cvValues=new ContentValues[cVVector.size()];
                cVVector.toArray(cvValues);
                mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI,cvValues);
